<template>
  <div class="swiper-content" style="margin: 150px auto 0;height: 100px;">
...
export default {
 data() {
  return {
   list: [{
     id: '1',
     url: '../../../static/img/carousel_1.jpg'
   }, {
     id: '2',
     url: '../../../static/img/carousel_2.jpg'
   }, {
     id: '3',
     url: '../../../static/img/carousel_3.jpg'
   }],
   swiperOption: {
